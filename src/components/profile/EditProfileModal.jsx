...
class EditProfileModal extends Component {
   ...
   * @description - a React lifecycle method
   * @returns {void}
   */
  ...
  onProfileSave = async () => {
    ...
    const { updateProfile: updateUserProfile, onToggleModal } = this.props;
...
export default connect(null, { updateProfile })(EditProfileModal);
